...
> "I ship full-stack products by orchestrating AI."

Live site: https://victortserovski.github.io
...
GitHub Pages auto-serves this user-site repo from the `main` branch root. Pushing to `main` triggers a deploy within ~1 minute.

## License

All rights reserved. © Victor Tserovski. The code is published here for transparency and as part of the portfolio itself; please don't clone-and-rebrand it as your own.
